		...
		Vars.content.blocks().each(
			cons((b) => {
				...
				try {
					if (
						b instanceof
							Packages.mindustry.world.blocks.environment
								.TallBlock ||
						b instanceof
							Packages.mindustry.world.blocks.environment
								.TreeBlock ||
...
Events.run(Trigger.update, () => {
	let t =
		Vars.state.isGame() && !Core.scene.hasMouse() && Core.input.isTouched()
			? Vars.world.tileWorld(
	...
	if (!c || c.block != Blocks.worldProcessor)
		return ((h = 0), (b = null), (o = false));
